...
import 'package:gemini_example/sections/chat.dart';
import 'package:gemini_example/sections/chat_stream.dart';
import 'package:gemini_example/sections/embed_batch_contents.dart';
import 'package:gemini_example/sections/embed_content.dart';
import 'package:gemini_example/sections/response_widget_stream.dart';
import 'package:gemini_example/sections/stream.dart';
import 'package:gemini_example/sections/text_and_image.dart';
import 'package:gemini_example/sections/text_only.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      darkTheme: ThemeData.dark().copyWith(colorScheme: ColorScheme.fromSeed(seedColor: Colors.blue), cardTheme: CardTheme(color: Colors.blue.shade900)),
